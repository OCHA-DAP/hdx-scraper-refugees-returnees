        ...
        with HDXErrorHandler() as error_handler:
            with temp_dir(
                ...
                with Download(user_agent="test") as downloader:
                    ...
                    assert resources == [
                        {
                            "name": "Global Affected People: Refugees & Persons of Concern (2020-2024)",
                            "description": "Refugees and Persons of Concern data (2020-2024) from HDX HAPI, please see [the documentation](https://hdx-hapi.readthedocs.io/en/latest/data_usage_guides/affected_people/#refugees-persons-of-concern) for more information",
                            "format": "csv",
                        }
                    ]
